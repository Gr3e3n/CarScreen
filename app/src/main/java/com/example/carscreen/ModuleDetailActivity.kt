...
import com.example.carscreen.data.ModuleCatalog
import com.example.carscreen.databinding.ActivityModuleDetailBinding
...
class ModuleDetailActivity : AppCompatActivity() {
    ...
    private fun buildParamsText(
        ...
        status: String?,
        module: com.example.carscreen.data.SafetyModule?,
    ): String {
